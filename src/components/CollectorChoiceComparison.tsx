...
export default function CollectorChoiceComparison() {
  return (
    <section className="bg-[#f2f7f4] py-16 md:py-20" aria-labelledby="collector-choice-title">
      <div className="container mx-auto px-4">
        <div className="mx-auto grid max-w-7xl gap-10 lg:grid-cols-[0.95fr_1.45fr] lg:items-start">
          <div className="text-center lg:pt-8 lg:text-left">
            ...
            >
              Ballard{' '}
              <span className="bg-gradient-to-r from-[#1f5a46] via-[#c8942f] to-[#8fb7a4] bg-clip-text text-transparent">
                Kelly
              </span>
            </h2>
            <p className="mx-auto mt-6 max-w-xl text-lg leading-8 text-[#102820] lg:mx-0">
          ...
          <div className="relative overflow-x-auto pb-2">
            <div className="grid min-w-[720px] grid-cols-[1.18fr_0.86fr_0.86fr] items-stretch">
              <div className="border-y border-[#1f5a46]/18 py-5" aria-hidden="true" />
              <div className="rounded-t-xl bg-gradient-to-br from-[#102820] via-[#1f5a46] to-[#c8942f] px-6 py-6 text-center shadow-[0_24px_60px_rgba(31,90,70,0.24)]">
                <div className="text-2xl font-black uppercase text-[#f2f7f4]">Ballard Kelly</div>
              </div>
              <div className="border-y border-[#1f5a46]/18 py-5 text-center">
                <div className="text-2xl font-black uppercase text-[#102820]">Other Sellers</div>
              </div>

              {comparisonRows.map((row, index) => (
                <div key={row.label} className="contents">
                  <div
                    className={`border-b border-[#1f5a46]/18 py-5 pr-5 text-xl font-medium tracking-[0.05em] text-[#102820] ${
                      index === 0 ? 'border-t' : ''
                    }`}
                  >
                    {row.label}
                  ...
                  <div
                    className={`flex items-center justify-center bg-gradient-to-br from-[#102820] via-[#1f5a46] to-[#c8942f] px-6 py-5 text-center text-lg font-bold text-[#f2f7f4] ${
                  ...
                  <div
                    className={`border-b border-[#1f5a46]/18 py-5 pl-5 text-center text-lg font-medium text-[#102820] ${
                      index === 0 ? 'border-t' : ''
                    }`}
                  >
                    {row.others}
        ...
        <div className="mx-auto mt-8 flex max-w-7xl items-start gap-3 rounded-lg bg-white px-5 py-4 text-[#1f5a46] shadow-sm md:px-6">
