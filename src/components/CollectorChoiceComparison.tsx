        ...
        <div className="mx-auto grid max-w-7xl gap-10 lg:grid-cols-[0.95fr_1.45fr] lg:items-start">
          ...
          <div className="relative overflow-x-auto pb-2">
            <div className="grid min-w-[720px] grid-cols-[1.18fr_0.86fr_0.86fr] items-stretch">
              ...
              <div className="rounded-t-xl bg-[#1f8f5f] px-6 py-6 text-center shadow-[0_24px_60px_rgba(31,90,70,0.24)]">
              ...
              {comparisonRows.map((row, index) => (
                <div key={row.label} className="contents">
                  ...
                  <div
                    className={`flex items-center justify-center bg-[#1f8f5f] px-6 py-5 text-center text-lg font-bold text-[#f2f7f4] ${
