      ...
      >
        ...
        <div className="mx-4 my-4 p-4 bg-gradient-to-br from-gray-50 to-gray-100/50 rounded-2xl border border-gray-100">
          <div className="flex items-center gap-3">
            <div className="w-10 h-10 bg-gradient-to-br from-[#12382f] to-[#1f5a46] rounded-full flex items-center justify-center ring-2 ring-white shadow-lg">
              ...
              {getMainNavItems(ordersCount).map((item) => {
                ...
                return (
                  ...
                  >
                    ...
                    {item.badge !== undefined && item.badge > 0 && (
                      <span className={`text-xs px-2 py-0.5 rounded-full font-semibold min-w-[1.5rem] text-center ${active ? 'bg-[#1f5a46]/20 text-[#f2f7f4]' : 'bg-red-500 text-white'
                        }`}>
                        {item.badge}
                      </span>
                    )}
          ...
          <div className="mt-2 pt-4 border-t border-gray-200 px-2 pb-2">
            <div className="grid grid-cols-2 gap-2">
              ...
              <a
                ...
                rel="noopener noreferrer"
                onClick={() => setMobileMenuOpen(false)}
                title="Open SMS tools"
                className="flex-1 flex items-center justify-center px-2 py-2.5 bg-gray-50 rounded-xl transition-all duration-200 hover:bg-gray-100"
              >
                <span className="font-bold text-[11px] tracking-wider uppercase text-gray-500" style={{ filter: 'brightness(0) saturate(100%) invert(69%) sepia(3%) saturate(1210%) hue-rotate(185deg) brightness(97%) contrast(92%)' }}>SMS Tools</span>
              </a>
