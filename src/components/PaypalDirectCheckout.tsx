...
const PaypalDirectCheckout: React.FC<PaypalDirectCheckoutProps> = ({
  ...
  const handlePayWithPayPal = () => {
    ...
    const fields: Record<string, string> = {
      ...
      rm: '0',
      bn: 'BallardKellyScott_BuyNow_WPS_US',
  ...
  return (
    <div className="fixed inset-0 z-[200] flex items-center justify-center p-4">
      {/* Backdrop */}
      <div
        className="absolute inset-0 bg-[#12382f]/40 backdrop-blur-sm animate-in fade-in duration-300"
        ...
        <div className="bg-[#003087] px-6 py-4 flex items-center justify-between">
          <div className="flex items-center gap-3">
            ...
            <div>
              ...
              <p className="text-emerald-200 text-xs">Secure redirect to PayPal</p>
            </div>
          </div>
          {!isRedirecting && (
            <button
        ...
        <div className="p-6">
          ...
          <div className="mb-5 p-4 bg-gray-50 rounded-2xl border border-gray-100">
            <div className="flex justify-between items-start mb-1">
              ...
              <span className="font-bold text-[#12382f] whitespace-nowrap text-base">
          ...
          <div className="mb-5 flex items-start gap-3 rounded-2xl border border-emerald-100 bg-emerald-50 p-4">
            <MapPin className="mt-0.5 h-4 w-4 shrink-0 text-[#12382f]" aria-hidden="true" />
            <div className="min-w-0">
              <p className="mb-1 text-xs font-semibold uppercase text-[#12382f]">Delivery address</p>
