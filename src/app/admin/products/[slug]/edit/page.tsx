    ...
    return (
      <AdminLayout title="Not Found">
        <div className="text-center py-16">
          ...
          <Link href={returnTo} className="text-[#12382f] hover:underline">← Back to products</Link>
        </div>
      </AdminLayout>
    );
  }
        ...
        <div className="flex items-center justify-between gap-4">
          ...
          <div className="flex items-center gap-2">
            ...
            <button
              ...
              disabled={saving}
              className="inline-flex items-center gap-2 px-4 py-2 bg-[#12382f] text-white text-sm font-medium rounded-xl hover:bg-[#276955] disabled:opacity-50 shadow-sm"
            >
            ...
            <div className="pt-4 border-t border-gray-100">
              <Field label="Target Market" hint="Sets the currency, shipping copy, and regional display for this product page">
                ...
                {formData.targetMarket && (
                  <p className="mt-1.5 text-xs text-emerald-800 bg-emerald-50 border border-emerald-100 px-3 py-1.5 rounded-lg">
