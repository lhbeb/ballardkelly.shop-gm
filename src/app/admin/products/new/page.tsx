...
function Section({
  ...
  return (
    <div className="bg-white rounded-2xl border border-gray-200 overflow-hidden">
      ...
      >
        <div className={`w-10 h-10 rounded-xl flex items-center justify-center flex-shrink-0 ${isOpen ? 'bg-[#12382f]/10' : 'bg-gray-100'}`}>
          <Icon className={`h-5 w-5 ${isOpen ? 'text-[#12382f]' : 'text-gray-500'}`} />
        </div>
        ...
        <div className="flex items-center justify-between gap-4">
          ...
          <div className="flex items-center gap-2">
            ...
            <button
              ...
              disabled={loading || formData.collections.length === 0}
              className="inline-flex items-center gap-2 px-4 py-2 bg-[#12382f] text-white text-sm font-medium rounded-xl hover:bg-[#276955] disabled:opacity-50 disabled:cursor-not-allowed shadow-sm"
              title={formData.collections.length === 0 ? 'Please select at least one collection' : ''}
            >
              {loading ? <Loader2 className="h-4 w-4 animate-spin" /> : <Save className="h-4 w-4" />}
              ...
              <Field label="Price" required>
                <div className="relative">
                  ...
                  <input
                    ...
                    placeholder="0.00"
                    required
                    className="w-full pl-8 pr-4 py-2.5 border border-gray-300 rounded-xl focus:ring-2 focus:ring-[#12382f] focus:border-[#12382f] outline-none transition-all"
                  />
                </div>
              </Field>
              ...
              {rotationSupported && (
                <div className="flex items-center gap-3">
                  <input
                    ...
                    className="h-5 w-5 rounded border-gray-300 text-[#12382f] focus:ring-[#12382f] outline-none transition-all cursor-pointer"
                  />
              ...
              {formData.checkout_flow !== 'paypal-api' && (!rotationSupported || !formData.rotate_links ? (
                <Field label="Checkout Link" required>
                  <input
                    ...
                    placeholder="https://..."
                    required
                    className="w-full px-4 py-2.5 border border-gray-300 rounded-xl focus:ring-2 focus:ring-[#12382f] focus:border-[#12382f] outline-none transition-all"
                  />
                </Field>
              ) : (
                <div className="space-y-3 p-4 bg-gray-50/50 rounded-xl border border-gray-100">
                  ...
                  {(formData.checkout_links.length > 0 ? formData.checkout_links : ['']).map((link, idx) => (
                    <div key={idx} className="flex items-center gap-2">
                      <input
                        ...
                        className="flex-grow px-4 py-2.5 border border-gray-300 rounded-xl focus:ring-2 focus:ring-[#12382f] focus:border-[#12382f] outline-none transition-all bg-white"
                        required
                      />
                  ...
                  <button
                    ...
                    className="flex items-center gap-1.5 text-xs font-bold text-[#12382f] hover:text-[#1f5a46] bg-white border border-gray-200 px-3 py-2 rounded-lg shadow-sm transition-all"
                  >
          ...
          <div className="space-y-4">
            ...
            <Field label="URL Slug" hint="Auto-generated from title. Only lowercase letters, numbers, and hyphens.">
              <div className="flex items-center">
                ...
                <input
                  ...
                  className="flex-1 px-4 py-2.5 border border-gray-300 rounded-xl focus:ring-2 focus:ring-[#12382f] focus:border-[#12382f] outline-none transition-all"
                />
              </div>
            </Field>
            ...
            <Field label="Description">
              <textarea
                ...
                rows={4}
                className="w-full px-4 py-2.5 border border-gray-300 rounded-xl focus:ring-2 focus:ring-[#12382f] focus:border-[#12382f] outline-none transition-all resize-none"
              />
            </Field>
                ...
                {PRODUCT_COLLECTION_OPTIONS.map((collection) => (
                  <label key={collection.value} className="flex items-center gap-3 cursor-pointer p-2 hover:bg-gray-50 rounded-lg">
                    <input
                      ...
                      className="w-4 h-4 rounded border-gray-300 text-[#12382f] focus:ring-[#12382f]"
            ...
            <div className="flex flex-wrap gap-6 pt-4 border-t border-gray-100">
              <label className={`inline-flex items-center gap-3 cursor-pointer ${featuredCount >= FEATURE_LIMIT && !formData.is_featured ? 'opacity-50' : ''}`}>
                ...
                />
                <div className="relative w-10 h-6 bg-gray-200 rounded-full peer-checked:bg-[#1f5a46] transition-colors">
          ...
          {formData.slug ? (
            <>
              ...
              {uploadStatus.message && (
                <p className={`mt-3 text-sm ${uploadStatus.uploading ? 'text-[#12382f]' : 'text-gray-500'}`}>
                  {uploadStatus.message}
                </p>
              )}
        ...
        <Section id="gmc" icon={Globe} title="Google Merchant Center" description="Product attributes for Google feeds" defaultOpen={false}>
          <div className="grid grid-cols-1 md:grid-cols-2 gap-5">
            <Field label="Google Product Category" hint="e.g. Home & Garden > Lawn & Garden > Outdoor Power Equipment">
              <input type="text" value={formData.gmc_category} onChange={(e) => updateField('gmc_category', e.target.value)} placeholder="Home & Garden > Lawn & Garden > Outdoor Power Equipment" className="w-full px-4 py-2.5 border border-gray-300 rounded-xl focus:ring-2 focus:ring-[#12382f] outline-none" />
            </Field>
            <Field label="Age Group" hint="newborn, infant, toddler, kids, adult">
              <input type="text" value={formData.gmc_age_group} onChange={(e) => updateField('gmc_age_group', e.target.value)} placeholder="e.g. adult" className="w-full px-4 py-2.5 border border-gray-300 rounded-xl focus:ring-2 focus:ring-[#12382f] outline-none" />
            </Field>
            <Field label="Color" hint="Primary color of the product">
              <input type="text" value={formData.gmc_color} onChange={(e) => updateField('gmc_color', e.target.value)} placeholder="e.g. Black" className="w-full px-4 py-2.5 border border-gray-300 rounded-xl focus:ring-2 focus:ring-[#12382f] outline-none" />
            </Field>
            <Field label="Gender" hint="male, female, unisex">
              <input type="text" value={formData.gmc_gender} onChange={(e) => updateField('gmc_gender', e.target.value)} placeholder="e.g. unisex" className="w-full px-4 py-2.5 border border-gray-300 rounded-xl focus:ring-2 focus:ring-[#12382f] outline-none" />
            </Field>
            <Field label="Size" hint="Product size (if fixed for this listing)">
              <input type="text" value={formData.gmc_size} onChange={(e) => updateField('gmc_size', e.target.value)} placeholder="e.g. XL" className="w-full px-4 py-2.5 border border-gray-300 rounded-xl focus:ring-2 focus:ring-[#12382f] outline-none" />
            </Field>
          </div>
        </Section>
            ...
            <div className="space-y-4 pt-4 border-t border-gray-100">
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                <Field label="OG Title">
                  <input type="text" value={formData.metaOgTitle} onChange={(e) => updateField('metaOgTitle', e.target.value)} placeholder={formData.title} className="w-full px-4 py-2.5 border border-gray-300 rounded-xl focus:ring-2 focus:ring-[#12382f] focus:border-[#12382f] outline-none" />
                </Field>
                <Field label="OG Image URL">
                  <input type="url" value={formData.metaOgImage} onChange={(e) => updateField('metaOgImage', e.target.value)} placeholder="https://..." className="w-full px-4 py-2.5 border border-gray-300 rounded-xl focus:ring-2 focus:ring-[#12382f] focus:border-[#12382f] outline-none" />
                </Field>
              </div>
              <Field label="OG Description">
                <textarea value={formData.metaOgDescription} onChange={(e) => updateField('metaOgDescription', e.target.value)} rows={2} className="w-full px-4 py-2.5 border border-gray-300 rounded-xl focus:ring-2 focus:ring-[#12382f] focus:border-[#12382f] outline-none resize-none" />
              </Field>
            </div>
            ...
            <div className="space-y-4 pt-4 border-t border-gray-100">
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                <Field label="Twitter Title">
                  <input type="text" value={formData.metaTwitterTitle} onChange={(e) => updateField('metaTwitterTitle', e.target.value)} placeholder={formData.title} className="w-full px-4 py-2.5 border border-gray-300 rounded-xl focus:ring-2 focus:ring-[#12382f] focus:border-[#12382f] outline-none" />
                </Field>
                <Field label="Twitter Image URL">
                  <input type="url" value={formData.metaTwitterImage} onChange={(e) => updateField('metaTwitterImage', e.target.value)} placeholder="https://..." className="w-full px-4 py-2.5 border border-gray-300 rounded-xl focus:ring-2 focus:ring-[#12382f] focus:border-[#12382f] outline-none" />
                </Field>
              </div>
              <Field label="Twitter Description">
                <textarea value={formData.metaTwitterDescription} onChange={(e) => updateField('metaTwitterDescription', e.target.value)} rows={2} className="w-full px-4 py-2.5 border border-gray-300 rounded-xl focus:ring-2 focus:ring-[#12382f] focus:border-[#12382f] outline-none resize-none" />
              </Field>
            </div>
          </div>
        </Section>
        ...
        <Section id="reviews" icon={Star} title="Reviews" description="Manage customer reviews" defaultOpen={false} badge={reviews.length}>
          <div className="space-y-4">
                  ...
                  <div key={review.id || i} className="flex items-start gap-3 p-3 bg-gray-50 rounded-xl group">
                    <div className="w-9 h-9 rounded-full flex-shrink-0 overflow-hidden bg-gray-200 flex items-center justify-center">
                      {typeof review.avatar === 'string' && review.avatar.length > 0 ? (
                        ...
                        <div className="w-9 h-9 bg-gradient-to-br from-[#12382f] to-purple-600 rounded-full flex items-center justify-center text-white text-sm font-medium">
            ...
            <button
              ...
              className="w-full py-2.5 border-2 border-dashed border-gray-200 rounded-xl text-gray-500 hover:border-[#12382f]/30 hover:text-[#12382f] transition-colors flex items-center justify-center gap-2"
            >
        ...
        <div className="fixed inset-0 z-50 flex items-center justify-center p-4 bg-black/50" onClick={() => setShowReviewModal(false)}>
          <div className="bg-white rounded-2xl shadow-2xl w-full max-w-md" onClick={e => e.stopPropagation()}>
            ...
            <div className="p-5 space-y-4 max-h-[70vh] overflow-y-auto">
              ...
              <div className="flex items-center gap-4">
                <label className="relative cursor-pointer group flex-shrink-0">
                  <div className="w-16 h-16 rounded-full overflow-hidden bg-gray-100 border-2 border-dashed border-gray-300 group-hover:border-[#12382f] transition-colors flex items-center justify-center">
              ...
              <div className="grid grid-cols-2 gap-4">
                <Field label="Author" required>
                  <input
                    ...
                    className="w-full px-3 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-[#12382f] outline-none"
                  />
                </Field>
                <Field label="Rating">
                  <select
                    ...
                    className="w-full px-3 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-[#12382f] outline-none bg-white"
                  >
              ...
              <Field label="Content" required>
                <textarea
                  ...
                  rows={3}
                  className="w-full px-3 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-[#12382f] outline-none resize-none"
                />
              </Field>
              <div className="grid grid-cols-2 gap-4">
              ...
              <label className="flex items-center gap-2 cursor-pointer">
                <input
                  ...
                  className="w-4 h-4 rounded text-[#12382f] focus:ring-[#12382f]"
                />
            ...
            <div className="p-5 border-t border-gray-100 flex justify-end gap-3">
              ...
              <button type="button" onClick={saveReview} className="px-4 py-2 bg-[#12382f] text-white rounded-lg hover:bg-[#276955]">
                Save
              </button>
            </div>
          </div>
