        ...
        <div className="bg-white rounded-2xl shadow-xl border border-gray-100 p-8 md:p-12 text-center">
            ...
            <div className="space-y-4">
              ...
              <div className="flex items-start space-x-3">
                ...
                <div className="text-left">
                  ...
                  <p className="text-sm text-gray-600">Your order is estimated to arrive within 2-4 business days</p>
                </div>
              </div>
            </div>
          </div>
          ...
          <div className="bg-emerald-50 rounded-xl p-6 mb-8">
            ...
            <div className="space-y-1 text-sm">
              ...
              <p className="text-gray-700">
                📞 <a href="tel:+13082601935" className="text-emerald-700 hover:text-emerald-800 font-medium">
                  +1 (308) 260-1935
                </a>
              </p>
            </div>
